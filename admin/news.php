                            ...
                            <div class="card">
                               ...
                               <div class="card-content">
                                    ...
                                    <div class="toolbar text-right">
                                        <a href="insertnews.php" class="btn btn-sm btn-info btn-icon"><i class="material-icons">add_box</i> Berita</a>
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead style="font-size: 13px">
                                                <tr><th style="font-weight: bold;text-align: center;">Foto</th>
                                                    ...
                                                    <th style="font-weight: bold;text-align: center;">Isi</th>
...
<?php
$hasil = $koneksi->QUERY("SELECT * from tb_news");
$rows = $hasil->fetch_All(MYSQLI_ASSOC);
foreach ($rows as $row):
    $isian = $row['isi'];
 ?>  
 <tr>
                                                    <td width="100px"><img src="news/<?php echo $row['foto']; ?>"></td>
                                                    <td><?php echo $row['judul']; ?></td>
                                                    <td><?php echo substr($isian,0, 100); ?></td>
                                                    <td class="text-right">
                                                        <a href="editnews.php?kd_news=<?php echo $row['kd_news']; ?>" class="btn btn-sm btn-warning btn-icon"><i class="material-icons">edit</i></a><br>
                                                        <a href="proses.php?kd_news=<?php echo $row['kd_news']; ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-sm btn-danger btn-icon"><i class="material-icons">delete</i></a>
                                                    </td>
 </tr>
   <?php 
endforeach;
