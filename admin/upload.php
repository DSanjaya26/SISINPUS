            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                       <div class="col-md-12">
                            <div class="card">
                                <form method="post" action="upload_aksi.php" class="form-horizontal" enctype="multipart/form-data">
...
if(isset($_GET['alert'])){
 ...
 ?>
                                        <div class="row">
                                        <div class="row">
                                            <label class="col-sm-2 label-on-left" style="color: black">Upload Data Anggota</label>
                                            <div class="col-sm-4">
                                            <input class="btn btn-file" type="file" name="fileanggota">
                                            </div>
                                            </div>                                            
                                        </div>
                                        </div>
