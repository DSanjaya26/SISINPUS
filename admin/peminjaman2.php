...
<?php
 $now = date('Y-m-d');
$hasil = $koneksi->QUERY("SELECT * FROM `tb_peminjaman` JOIN tb_buku on tb_peminjaman.kd_buku = tb_buku.kd_buku JOIN tb_anggota on tb_peminjaman.kd_anggota = tb_anggota.NomorInduk where tb_peminjaman.status = 'Dipinjam' AND tb_peminjaman.tgl_kembali < '$now'");
