                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <div class="collapse" id="Transaksi">
                            <ul class="nav">
                                <li>
                                   <a href="../peminjaman.php">Data Peminjaman & Pengembalian Buku</a>
                                </li>
                                <li>
                                    <a href="../history.php">Data Histori Peminjaman</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="collapse" id="laporan">
                            <ul class="nav">
                                ...
                                <li>
                                   <a href="bukuHilang.php">Data Buku Hilang</a>
                                </li>
                                <li>
                                    <a href="peminjaman.php">Data Transaksi</a>
                                </li>
                            </ul>
                        </div>
                    </li>
