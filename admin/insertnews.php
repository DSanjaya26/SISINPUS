...
if(isset($_GET['alert'])){
 ...
 ?>
                                        <div class="row">
                                            <label class="col-sm-2 label-on-left" style="color: black">Judul Berita</label>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10"><textarea class="ckeditor" id="ckeditor" name="isi"></textarea></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-3 col-sm-offset-5">
                                            <input type="submit" class="btn btn-info btn-md" value="Tambah" name="TambahNews">
                                            </div>
                                        </div>
                                    </div>
                                </form>
