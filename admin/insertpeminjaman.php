                                ...
                                <form method="post" action="proses.php" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="card-content">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" name="nis" onkeyup="isi_otomatis()" id="nis">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" name="kd_buku" onkeyup="isi_otomatis2()" id="kd_buku">
                                                </div>
                                            </div>
                                            ...
                                            <label class="col-sm-2 label-on-left" style="color: black">Tanggal Akhir Pinjam</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="submit" class="btn btn-info btn-md" value="Tambah" name="TambahPeminjaman">
                                            </div>
                                        </div>
                                    </div>
                                </form>
