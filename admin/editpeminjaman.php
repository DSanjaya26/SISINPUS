...
$hasil = $koneksi->QUERY("SELECT * from tb_peminjaman join tb_buku on tb_peminjaman.kd_buku = tb_buku.kd_buku where kd_peminjaman = $kd;");
...
?>  
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    ...
                                                    <input type="hidden" class="form-control" readonly name="kd_peminjaman" value="<?php echo $row['kd_peminjaman']; ?>">
                                                    <input type="text" class="form-control" readonly value="<?php echo $row['kd_anggota']; ?>">
                                                </div>
                                            </div>
                                            <label class="col-sm-2 label-on-left" style="color: black">Nama Buku</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" readonly value="<?php echo $row['judul']; ?>">
                                                </div>
                                            </div>
                                            <label class="col-sm-2 label-on-left" style="color: black">Tanggal Mulai Pinjam</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="date" class="form-control" readonly value="<?php echo $row['tgl_pinjam']; ?>">
                                                </div>
                                            </div>
                                            <label class="col-sm-2 label-on-left" style="color: black">Perpanjangan Pinjaman</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="date" class="form-control" value="<?php echo $row['tgl_kembali']; ?>" name="tgl_kembali">
                                                </div>
                                            </div> 
<?php 
endforeach;
 ?>                                              
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="submit" class="btn btn-info btn-md" value="Tambah" name="EditPeminjaman">
                                            </div>
                                        </div>
                                    </div>
                                </form>
