                            ...
                            <div class="card">
                                <form method="post" action="proses.php" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="card-header card-header-text" data-background-color="blue">
                                        <h4 class="card-title">Pengembalian Buku Hilang</h4>
...
$kd_peminjaman = $_GET['kd_peminjaman'];
 ?>
                                         <div class="row">
                                            <label class="col-sm-2 label-on-left" style="color: black">Kode Peminjaman</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" name="kd_peminjaman" value="<?php echo $kd_peminjaman; ?>" readonly>
                                                </div>
                                            </div>
                                       
                                            <label class="col-sm-2 label-on-left" style="color: black">Jumlah Buku yang hilang</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                            ...
                                            <label class="col-sm-2 label-on-left" style="color: black">Denda buku hilang (Harga/Buku)</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="submit" class="btn btn-info btn-md" value="Simpan" name="TambahHilang">
                                            </div>
                                        </div>
                                    </div>
                                </form>
