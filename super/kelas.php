            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Dashboard > Kelas </a>
                    </div>
                </div>
            </nav>
            <div class="content">
                            ...
                            <div class="card">
                               ...
                               <div class="card-content">
                                    ...
                                    <div class="toolbar text-right">
                                       <a href="insertkelas.php" class="btn btn-sm btn-info btn-icon"><i class="material-icons">add_box</i></a>
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead style="font-size: 12px;">
                                                <tr>
                                                    <th style="font-weight: bold;">Kode Kelas</th>
...
foreach ($rows as $row):
 ?>  
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                      <a href="proses.php?kd_kelas=<?php echo $row['kd_kelas']; ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-sm btn-danger btn-icon"><i class="material-icons">delete</i></a>
                                                    </td>
                                                </tr>
<?php 
endforeach;
