            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                       <div class="col-md-12">
                            <div class="card">
                                <form method="post" action="prosesupdatefoto.php" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="card-content">
                                        <div class="row">
                                            ...
                                            <label class="col-sm-2 label-on-left" style="color: black">Upload Foto</label>
                                            <div class="col-sm-4">
                                            <input class="btn btn-file" type="file" name="foto" placeholder="tes">
                                            </div>                                          
                                        </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-3 col-sm-offset-5">
                                            <input type="submit" class="btn btn-info btn-md" value="Ganti Foto" name="UpdateFoto">
                                            </div>
                                        </div>
                                    </div>
                                </form>
