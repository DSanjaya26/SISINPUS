                            ...
                            <div class="card">
                               ...
                               <div class="card-content">
                                    ...
                                    <div class="toolbar text-right">
                                        <a href="insertadmin.php" class="btn btn-sm btn-info btn-icon"><i class="material-icons">add_box</i></a>
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead style="font-size: 12px;">
                                                <tr><th style="font-weight: bold;">NIP</th>
                                            ...
                                            <tbody>
<?php
$hasil = $koneksi->QUERY("SELECT * FROM tb_anggota JOIN tb_login on tb_anggota.NomorInduk = tb_login.username where akses='admin';");
...
foreach ($rows as $row):
 ?>  
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a href="editadmin.php?nis=<?php echo $row['NomorInduk']; ?>" class="btn btn-sm btn-warning btn-icon"><i class="material-icons">edit</i></a>
                                                        <a href="admin.php?NomorInduk=<?php echo $row['NomorInduk']; ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-sm btn-danger btn-icon"><i class="material-icons">delete</i></a>
                                                    </td>
                                                </tr>
<?php 
endforeach;
