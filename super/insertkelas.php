...
$query = mysqli_query($koneksi, "SELECT max(kd_kelas) as kode FROM tb_kelas");
$data = mysqli_fetch_array($query);
$kodekelas = $data['kode'];

// mengambil angka dari kode terbesar, menggunakan fungsi substr
// dan diubah ke integer dengan (int)
$urutan = (int) substr($kodekelas, 4, 3);
...
if(isset($_GET['alert'])){
 ...
 ?>
                                         <div class="row">
                                            <label class="col-sm-2 label-on-left" style="color: black">Kode kelas</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" name="kodekls" value="<?php echo $kode; ?>" readonly>
                                                </div>
                                            </div>
                                       
                                            <label class="col-sm-2 label-on-left" style="color: black">Nama Kelas</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="submit" class="btn btn-info btn-md" value="Tambah" name="TambahKelas">
                                            </div>
                                        </div>
                                    </div>
                                </form>
