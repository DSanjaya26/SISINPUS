...
if(isset($_GET['alert'])){
 ...
 ?>
                                        <div class="row">
                                            <label class="col-sm-2 label-on-left" style="color: black">NIP / NIS</label>
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="radio">
                                                    <label style="color: black">
                                                        <input type="radio" name="JK" value="L" checked="true"> Lak-laki
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label style="color: black">
                                            ...
                                            <label class="col-sm-2 label-on-left" style="color: black">Status Anggota</label>
                                            <div class="col-sm-4">
                                                <select class="selectpicker" data-style="select-with-transition" name="status">
                                                    <option value="Siswa">Pilih Status</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <label class="col-sm-offset-1">
                                                *Catatan : <br>
                                                Password login dibuat secara otomatis menggunakan nomor telepon anggota</label>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-3 col-sm-offset-5">
                                            <input type="submit" class="btn btn-info btn-md" value="Tambah" name="TambahAnggota">
                                            </div>
                                        </div>
                                    </div>
                                </form>
