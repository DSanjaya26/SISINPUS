                            ...
                            <div class="card">
                                <form method="post" action="proses.php" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="card-header card-header-text" data-background-color="blue">
                                        <h4 class="card-title">Tambah Kategori Buku Perpustakaan</h4>
...
if(isset($_GET['alert'])){
 ...
 ?>
                                         <div class="row">
                                            <label class="col-sm-2 label-on-left" style="color: black">Nama Kategori</label>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="submit" class="btn btn-info btn-md" value="Tambah" name="TambahKategori">
                                            </div>
                                        </div>
                                    </div>
                                </form>
