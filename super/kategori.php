            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Dashboard > Kategori Buku </a>
                    </div>
                </div>
            </nav>
            <div class="content">
    ...
    if ($_GET['alert'] == "berhasildelete") {
        echo '<div class="alert alert-success col-sm-10 col-md-offset-1" role="alert">
                         <div class="alert-icon">
                          ...
                          <p>Kategori berhasil di hapus</p>
                </div>';
    }
 ...
 ?>
                            ...
                            <div class="card">
                               ...
                               <div class="card-content">
                                    <h4 class="card-title">Data Kategori Buku Perpustakaan</h4>
                                    <div class="toolbar text-right">
                                        <a href="insertkategori.php" class="btn btn-sm btn-info btn-icon"><i class="material-icons">add_box</i></a>
                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead style="font-size: 12px;">
                                                <tr>
                                                    <th style="font-weight: bold;">Kode Kategori</th>
...
foreach ($rows as $row):
 ?>  
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                      <a href="proses.php?kd_kategori=<?php echo $row['kd_kategori']; ?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-sm btn-danger btn-icon"><i class="material-icons">delete</i></a>
                                                    </td>
                                                </tr>
<?php 
endforeach;
