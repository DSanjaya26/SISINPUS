...
$query = mysqli_query($koneksi, "SELECT max(kd_rak) as kode FROM tb_rak");
$data = mysqli_fetch_array($query);
$koderak = $data['kode'];

// mengambil angka dari kode terbesar, menggunakan fungsi substr
// dan diubah ke integer dengan (int)
$urutan = (int) substr($koderak, 4, 3);
                            ...
                            <div class="card">
                                <form method="post" action="proses.php" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="card-header card-header-text" data-background-color="blue">
                                        <h4 class="card-title">Tambah Rak Perpustakaan</h4>
...
if(isset($_GET['alert'])){
 ...
 ?>
                                         <div class="row">
                                            <label class="col-sm-2 label-on-left" style="color: black">Kode Rak</label>
                                            <div class="col-sm-4">
                                            ...
                                            <label class="col-sm-2 label-on-left" style="color: black">Nama Rak</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="submit" class="btn btn-info btn-md" value="Tambah" name="TambahRak">
                                            </div>
                                        </div>
                                    </div>
                                </form>
