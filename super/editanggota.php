...
<?php
$nis = $_GET['nis'];
$hasil = $koneksi->QUERY("SELECT * FROM tb_anggota JOIN tb_login on tb_anggota.NomorInduk = tb_login.username where NomorInduk = $nis");
$rows = $hasil->fetch_All(MYSQLI_ASSOC);
foreach ($rows as $row):
 ?>  
                                        <div class="row">
                                            <label class="col-sm-2 label-on-left" style="color: black">NIS</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" name="NomorInduk" value="<?php echo $row['NomorInduk']; ?>" readonly>
                                                    <input type="hidden" class="form-control" name="kd_datakelas" value="<?php echo $row['kd_datakelas']; ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" name="nama" value="<?php echo $row['nama_anggota']; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="radio">
                                                    <label style="color: black">
                                                        <input type="radio" name="JK" value="L" <?php if($row['jk_anggota']=='L') echo 'checked'?>> Laki-laki
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label style="color: black">
                                                        <input type="radio" name="JK" value="P" <?php if($row['jk_anggota']=='P') echo 'checked'?>> Perempuan
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" name="nomor" value="<?php echo $row['no_telp']; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <label class="col-sm-2 label-on-left" style="color: black">Password Baru</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
 ...
 ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <label class="col-sm-offset-1">
                                                *Catatan : <br>
                                                Tidak perlu mengisi kolom password jika tidak melakukan perubahan password
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-3 col-sm-offset-5">
                                            <input type="submit" class="btn btn-info btn-md" value="Update" name="UpdateAnggota">
                                            </div>
                                        </div>
                                    </div>
                                </form>
