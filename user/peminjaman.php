 ...
 ?>
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Data Peminjaman Buku Aktif</h4>
...
<?php
$hasil = $koneksi->QUERY("SELECT * FROM `tb_peminjaman` JOIN tb_buku on tb_peminjaman.kd_buku = tb_buku.kd_buku JOIN tb_anggota on tb_peminjaman.kd_anggota = tb_anggota.NomorInduk where tb_peminjaman.kd_anggota = $user and tb_peminjaman.status = 'Dipinjam'");
