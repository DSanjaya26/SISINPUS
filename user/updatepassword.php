            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                       <div class="col-md-12">
                            <div class="card">
                                <form method="post" action="prosesupdatepass.php" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="card-header card-header-text" data-background-color="blue">
                                        <h4 class="card-title">Ganti Password</h4>
                                    </div>
                                    <div class="card-content">
                                        <div class="row">
                                            <label class="col-sm-2 label-on-left" style="color: black">Masukkan Password Baru</label>
                                        
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                                      <input type="hidden" class="form-control" name="nis" value="<?php echo $user ?>">
                                                  
                                                    <input type="Password" class="form-control" name="pw_new">
                                                </div>
                                            </div>
                                                <label class="col-sm-2 label-on-left" style="color: black">Konfirmasi Password Baru</label>
                                            <div class="col-sm-4">
                                                <div class="form-group form-info label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="Password" class="form-control" name="pw_new1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-3 col-sm-offset-5">
                                            <input type="submit" class="btn btn-info btn-md" value="Ganti Password" name="UpdatePass">
                                            </div>
                                        </div>
                                    </div>
                                </form>
